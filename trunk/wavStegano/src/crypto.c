...
#define EXTRA_SPACE  32//Extra space for algorithm... who knows?
...
int setCryptoPass(encryption_t *enc, unsigned char *password) {
	setCryptoPassOrKey(enc, passOrKey_pass);
	enc->passKeyIv.password = password;
	return 1;
}
