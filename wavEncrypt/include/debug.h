...
/*
 * Archivo para realizar debbugging en el código y no llenar de printfs
 * Existen 4 Niveles
 * 	DEBUG_LOG
 * 	DEBUG_WARN
 *  DEBUG_ERROR
 ...
 *  	LOG("Inicializando\n");
 *
 *  En la salida estandar se verá
 *
 *  	log:file:line - Inicializando
 *
 *
 *  O también con argumentos variables
 *
 *  	WARN("Retorno: %d",ret);
 *
 ...
 *
 *  Si no se especifica, todos los logs serán eliminados
 */
